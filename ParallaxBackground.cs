...
public class ParallaxBackground : MonoBehaviour
{
    ...
    public float horSmoothing;        // How smooth the parallax effect should be
    public float verSmoothing;
    ...
    private void Update()
    {
        ...
        // Vector3 backTargetPosition = new Vector3(this.transform.position.x, this.transform.position.y, this.transform.position.z);

        // this.transform.position = Vector3.Lerp(this.transform.position, backTargetPosition, verSmoothing * Time.deltaTime);
        
        // this.transform.position = new Vector3(this.transform.position.x, cameraTransform.position.y + 26f, this.transform.position.z);
